...
As seen in the analysis section, Open Street Map has the potential to offer this but there are a number of flows in that data the present real challenges to someone using the map for the analysis of cycling networks. 
